...
class WhenExplore extends StatelessWidget {
  int index;
  WhenExplore({Key? key, required this.index}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(invCtrl.deals[index].name),
        centerTitle: true,
      ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: NetworkImage(invCtrl.deals[index].assets[0]),
                        fit: BoxFit.cover)),
              ),
                          ...
                          children: [
                            ...
                            TextButton(
                              onPressed: () => showModalBottomSheet(
                                  ...
                                  builder: (context) => InvPurchase(ind:index)),
                              style: ButtonStyle(
                  ...
                  Row(
                    ...
                    children: [
                      buildLeftTile(
                          ...
                          desc: invCtrl.deals[index].returns,
                          ctx: context),
                      buildRightTile(
                          title: 'Duration',
                          desc: invCtrl.deals[index].duration,
                          ctx: context)
                    ],
                  ),
                  Row(
                    ...
                    children: [
                      buildLeftTile(
                          ...
                          desc: invCtrl.deals[index].invType,
                          ctx: context),
                      buildRightTile(
                          title: 'Investment Sector',
                          desc: invCtrl.deals[index].invSector,
                          ctx: context)
                    ],
                  ),
                  Row(
                    ...
                    children: [
                      buildLeftTile(
                          title: 'Payout Type',
                          desc: invCtrl.deals[index].payoutType,
                          ctx: context),
                      buildRightTile(
                          title: 'Unit Type',
                          desc: invCtrl.deals[index].unitType,
                          ctx: context)
                    ],
                  ),
                  Row(
                    ...
                    children: [
                      buildLeftTile(
                          ...
                          desc: invCtrl.deals[index].insurancePatner,
                          ctx: context),
                      buildRightTile(
                          title: 'Location',
                          desc: invCtrl.deals[index].location,
                          ctx: context)
                    ],
                  ),
                ],
