...
class WhenActive extends StatelessWidget {
  int index;
  WhenActive({Key? key, required this.index}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(invCtrl.active[index].invDetails.name),
        centerTitle: true,
      ),
                            ...
                            text: TextSpan(
                                ...
                                children: <TextSpan>[
                                  ...
                                  TextSpan(
                                    //to be changed
                                    text:
                                        '${invCtrl.active[index].invDetails.cost}',
                                    style: TextStyle(
                                        fontWeight: FontWeight.w600,
              ...
              Row(
                ...
                children: [
                  buildLeftTile(
                      ctx: context,
                      title: 'Units Held',
                      desc: invCtrl.active[index].unitsHeld),
                  buildRightTile(
                      ctx: context,
                      title: 'Amount Invested',
                      desc: invCtrl.active[index].capital)
                ],
              ),
                    ...
                    Row(
                      ...
                      children: [
                        buildLeftTile(
                            ...
                            desc: invCtrl.active[index].invDetails.returns,
                            ctx: context),
                        buildRightTile(
                            title: 'Duration',
                            desc: invCtrl.active[index].invDetails.duration,
                            ctx: context)
                      ],
                    ),
                    Row(
                      ...
                      children: [
                        buildLeftTile(
                            ...
                            desc: invCtrl.active[index].invDetails.invType,
                            ctx: context),
                        buildRightTile(
                            title: 'Investment Sector',
                            desc: invCtrl.active[index].invDetails.invSector,
                            ctx: context)
                      ],
                    ),
                    Row(
                      ...
                      children: [
                        buildLeftTile(
                            title: 'Payout Type',
                            desc: invCtrl.active[index].invDetails.payoutType,
                            ctx: context),
                        buildRightTile(
                            title: 'Unit Type',
                            desc: invCtrl.active[index].invDetails.unitType,
                            ctx: context)
                      ],
                    ),
                    Row(
                      ...
                      children: [
                        buildLeftTile(
                            ...
                            desc: invCtrl
                                .active[index].invDetails.insurancePatner,
                            ctx: context),
                        buildRightTile(
                            title: 'Location',
                            desc: invCtrl.active[index].invDetails.location,
                            ctx: context)
                      ],
                    ),
                  ])
